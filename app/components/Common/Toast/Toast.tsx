...
const Toast: FC<ToastProps> = ({ open, children, className, title, describe, prefixIcon, ...props }) => (
  <div
    {...props}
    className={clsx(
      className,
      "sm:max-w-[375px] sm:w-full",
      "fixed bottom-4 left-1/2 -translate-x-1/2 w-10/12 sm:translate-x-0 sm:bottom-4 sm:left-auto sm:right-4",
    ...
    <div className="h-full flex flex-col justify-center ml-3">
      <span className="font-bold text-white dark:text-black block">{title}</span>
